							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="pb-2">Database Name</label>
										<input type="text" name="dbname" id="dbname" class="form-control" placeholder="a-z A-Z 0-9">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label class="pb-2">Refundable ?</label>
								...
								<div class="col-md-12" id="cardsinfodiv">
									<label class="pb-2">Insert your cards</label>
									<textarea class="form-control" id="cards" style="min-height:450px; max-height: 100vh;"></textarea>
								</div>
			...
			<div class="col-md-4">
				...
				<div id="cardlog" class="card mt-2 d-none">
					<div class="card-body" >
						<div class="mt-2">
							<div class="form-group d-grid">
								<button id="copyinval" class="btn btn-info" data-api="copyInvalid-this">Copy Invalid Cards <span class="bx bx-copy"></span></button>
							</div>
