						...
						<form id="addForm">
							<div class="row">
								...
								<div class="col-md-12" id="cardsinfodiv">
									<label class="pb-2">Insert your RDP list</label>
									<textarea class="form-control" id="rdp" style="min-height:450px; max-height: 100vh;"></textarea>
								</div>
			...
			<div class="col-md-4">
				...
				<div id="cardlog" class="card mt-2 d-none">
					<div class="card-body" >
						<div class="mt-2">
							<div class="form-group d-grid">
								<button id="copyinval" class="btn btn-info" data-api="copyInvalid-this">Copy Invalid  RDP List <span class="bx bx-copy"></span></button>
							</div>
